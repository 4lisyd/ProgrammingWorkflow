...
> **Status:** 🚧 Incomplete — Documenting as I refine my setup. 
...
6. Manual trigger 'bindkeys' and custom scripts in ZSH env i.e (Control + Space = Find in Files, Option + Space = Find in Folders) with ripgrep for instant!!! system-wide search. Made with Eza.
